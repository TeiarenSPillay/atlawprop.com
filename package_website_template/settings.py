...
### Site specifics ###
SERVER_EMAIL = 'root@ws01.umh.propdata.net'
WEB_STATS  = "http://ws01.umh.propdata.net/cgi-bin/awstats.pl?config=abcrealestate.co.za"
WEBSITE_URL = "http://www.abcrealestate.co.za"
...
if DEV_MODE:
    ...
    DATABASE_NAME = 'abcrealestate_emile'               # Or path to database file if using sqlite3.
    ...
    DATABASE_ENGINE = 'postgresql_psycopg2' # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
    DATABASE_NAME = 'abcrealestate'               # Or path to database file if using sqlite3.
    ...
    DATABASE_PORT = ''                      # Set to empty string for default. Not used with sqlite3.
    GMAPS_KEY  = "ABQIAAAA_Yybjn6ImVf5RW9whzzNDBSC4RLQvT_DwTveTaBlF3030U__UxR1s8ntjiTom_p4WrEp8IichGFxVw" # abcrealestate.co.za
...
ROOT_URLCONF = 'abcrealestate.urls'
